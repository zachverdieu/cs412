...
SECRET_KEY = "django-insecure-i3)b-awfbg^h%spz&jc2-eirb!n*4u8ji==i2jw0316uf*77!2"
...
INSTALLED_APPS = [
    ...
    "marathon_analytics", # Module 8 example
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/zverdieu/static/'
    MEDIA_URL = '/uszverdieuername/media/'
